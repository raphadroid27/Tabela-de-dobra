...
def criar_aba2(notebook):
    ...
    g.linha_dobra1_entry = tk.Label(frame_aba2, relief="sunken", width=10)
    g.linha_dobra1_entry.grid(row=1, column=3, sticky='we', padx=2)
    g.linha_dobra2_entry = tk.Label(frame_aba2, relief="sunken", width=10)
    g.linha_dobra2_entry.grid(row=2, column=3, sticky='we', padx=2)
    g.linha_dobra3_entry = tk.Label(frame_aba2, relief="sunken", width=10)
    g.linha_dobra3_entry.grid(row=3, column=3, sticky='we', padx=2)
    g.linha_dobra4_entry = tk.Label(frame_aba2, relief="sunken", width=10)
    g.linha_dobra4_entry.grid(row=4, column=3, sticky='we', padx=2)
    g.linha_dobra5_entry = tk.Label(frame_aba2, relief="sunken", width=10)
    g.linha_dobra5_entry.grid(row=5, column=3, sticky='we', padx=2)
