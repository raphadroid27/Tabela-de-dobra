"""
Sistema centralizado de gerenciamento de widgets para evitar redundâncias e melhorar a modularização.
"""
...
class WidgetManager:
    ...
    def get_dobra_widgets(cls, valor_w: int) -> Dict[str, List[QWidget]]:
        ...
        for i in range(1, g.N):
            ...
            medida_label = cls.safe_get_widget(f'medidadobra{i}_label_{valor_w}')
            metade_label = cls.safe_get_widget(f'metadedobra{i}_label_{valor_w}')
        ...
        # Widgets de blank
        widgets['medida_blank_label'] = cls.safe_get_widget(f'medida_blank_label_{valor_w}')
        widgets['metade_blank_label'] = cls.safe_get_widget(f'metade_blank_label_{valor_w}')
