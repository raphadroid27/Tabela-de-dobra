...
class WidgetValidator:
    ...
    def validate_required_widgets(widget_names: List[str], 
        ...
        missing_widgets = [name for name, exists in validation_results.items() if not exists]
        
        if missing_widgets:
            print(f"Erro na {operation_name}: Widgets não inicializados: {missing_widgets}")
    ...
    def validate_combobox_selections(combobox_names: List[str],
        ...
        for name in combobox_names:
            ...
            if widget and isinstance(widget, QComboBox):
                ...
                empty_comboboxes.append(name)  # Widget não existe ou não é combobox
        
        if empty_comboboxes:
            print(f"Erro na {operation_name}: Comboboxes sem seleção: {empty_comboboxes}")
...
class OperationHelper:
    ...
    def validate_deducao_operation() -> Tuple[bool, Dict[str, str]]:
        ...
        """
        required_widgets = ['DED_ESPES_COMB', 'DED_CANAL_COMB', 'DED_MATER_COMB', 'DED_VALOR_ENTRY']
        ...
        entry_values = WidgetValidator.get_entry_values(['DED_VALOR_ENTRY', 'DED_OBSER_ENTRY', 'DED_FORCA_ENTRY'])
    ...
    def validate_material_operation() -> Tuple[bool, Dict[str, str]]:
        ...
        Returns:
            Tupla (is_valid, values_dict)
        """
        required_widgets = ['MAT_NOME_ENTRY', 'MAT_DENS_ENTRY', 'MAT_ESCO_ENTRY', 'MAT_ELAS_ENTRY']
    ...
    def validate_canal_operation() -> Tuple[bool, Dict[str, str]]:
        ...
        optional_widgets = ['CANAL_LARGU_ENTRY', 'CANAL_ALTUR_ENTRY', 'CANAL_COMPR_ENTRY', 'CANAL_OBSER_ENTRY']
