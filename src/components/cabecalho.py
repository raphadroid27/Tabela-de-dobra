...
def criar_widget(frame, tipo, linha_coluna, **kwargs):
    '''
...
def cabecalho(root):
    ...
    material_widget = criar_widget(frame_cabecalho, 'combobox',
                 (1, 0),
                 justify="center"
                 )
    ...
    espessura_widget = criar_widget(frame_cabecalho,
                 'combobox',
                 (1, 1),
                 justify="center"
                 )
    ...
    canal_widget = criar_widget(frame_cabecalho,
                 'combobox',
                 (1, 2),
                 justify="center"
                 )
    ...
    comprimento_widget = criar_widget(frame_cabecalho,
                 'entry',
                 (1, 3),
                 justify="center"
                 )
    ...
    raio_interno_widget = criar_widget(frame_cabecalho,
                 'entry',
                 (3, 0),
                 justify="center"
                 )
    ...
    fator_k_widget = criar_widget(frame_cabecalho,
                 'label',
                 (3, 1)
                 )
    ...
    deducao_widget = criar_widget(frame_cabecalho,
                 'label',
                 (3, 2)
                 )
    ...
    offset_widget = criar_widget(frame_cabecalho,
                 'label',
                 (3, 3)
                 )
    ...
    deducao_especifica_widget = criar_widget(frame_cabecalho,
                 'entry',
                 (5, 0), fg="blue",
                 justify="center"
                 )
    ...
    aba_minima_widget = criar_widget(frame_cabecalho, 'label', (5, 1))
    aba_minima_widget.grid(sticky='w')

    # Z90°
    criar_label(frame_cabecalho, "Ext. Z90°:", (4, 2))
    z90_widget = criar_widget(frame_cabecalho, 'label', (5, 2))
    z90_widget.grid(sticky='w')

    # tom/m
    criar_label(frame_cabecalho, "Ton/m:", (4, 3))
    ton_m_widget = criar_widget(frame_cabecalho, 'label', (5, 3))
    ton_m_widget.grid(sticky='w')

    # Observações
    criar_label(frame_cabecalho, "Observações:", (6, 0)).grid(columnspan=4)
    observacoes_widget = criar_widget(frame_cabecalho, 'label', (7, 0))
