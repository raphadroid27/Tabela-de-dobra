...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", "-m", choices=["stat", "patch", "nenhum"], default="stat",
                      help="Modo de exibição: 'stat' para estatísticas resumidas, 'patch' para diff completo, 'nenhum' para apenas commits")
    parser.add_argument("--format", "-f", choices=["completo", "oneline", "custom"], default="completo",
