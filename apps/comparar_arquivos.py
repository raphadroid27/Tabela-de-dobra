"""
Aplicativo Independente para Comparação de Arquivos.

Este aplicativo permite aos utilizadores carregar arquivos (STEP, IGES, PDF, DXF, DWG)
...
Versão independente do formulário de comparação.
"""
...
def main(parent=None):
    ...
    dialog = FormCompararArquivos(parent)
    dialog.show()
    return dialog
