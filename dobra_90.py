...
def entradas_dobras(valor, w):
    ...
    for label in labels:
        ttk.Label(g.FRAME_DOBRA, text=label, style="Titulo.TLabel").grid(row=0, column=labels.index(label)+1)

    for i in range(1, g.N):
        g.FRAME_DOBRA.rowconfigure(0, weight=0)
        g.FRAME_DOBRA.rowconfigure(i, weight=0)

        ttk.Label(g.FRAME_DOBRA, text=f"Aba {i}:").grid(row=i, column=0)

        setattr(g, f'aba{i}_entry_{w}', ttk.Entry(g.FRAME_DOBRA,
                                                  width=LARGURA,
                                                  justify="center"
                                                  ))
        ...
        setattr(g, f'medidadobra{i}_label_{w}', ttk.Label(g.FRAME_DOBRA,
                                                         style="Campo.TLabel",
                                                         width=LARGURA))
        ...
        setattr(g, f'metadedobra{i}_label_{w}', ttk.Label(g.FRAME_DOBRA,
                                                         style="Campo.TLabel",
                                                         width=LARGURA))
    ...
    ttk.Label(g.FRAME_DOBRA,
              text="Medida do Blank:",
              style="Titulo.TLabel",
             ).grid(row=i+1,
                    column=0,
                    columnspan=2,
    ...
    setattr(g, f'medida_blank_label_{w}', ttk.Label(g.FRAME_DOBRA,
                                                   style="Campo.TLabel",
                                                   width=LARGURA))
    ...
    setattr(g, f'metade_blank_label_{w}', ttk.Label(g.FRAME_DOBRA,
                                                   style="Campo.TLabel",
                                                   width=LARGURA))
