...
def cabecalho(root):
    ...
    g.canal_combobox.bind("<<ComboboxSelected>>", lambda event: atualizar())
    g.espessura_combobox.bind("<<ComboboxSelected>>", lambda event: atualizar())
    g.material_combobox.bind("<<ComboboxSelected>>", lambda event: atualizar())

    g.raio_interno_valor.bind("<KeyRelease>", lambda event: atualizar())