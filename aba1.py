...
def criar_aba1(notebook):
    ...
    tk.Label(frame_aba1, text="Dobra 2:").grid(row=1, column=0, padx=5, pady=5)
    tk.Label(frame_aba1, text="Dobra 3:").grid(row=2, column=0, padx=5, pady=5)
    tk.Label(frame_aba1, text="Dobra 4:").grid(row=3, column=0, padx=5, pady=5)
    tk.Label(frame_aba1, text="Dobra 5:").grid(row=4, column=0, padx=5, pady=5)
