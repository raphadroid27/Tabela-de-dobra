...
def criar_aba1(notebook):
    ...
    tk.Label(frame_aba1, text="Dobra 1:").grid(row=0, column=0, padx=5, pady=0)
    tk.Label(frame_aba1, text="Dobra 2:").grid(row=1, column=0, padx=5, pady=0)
    tk.Label(frame_aba1, text="Dobra 3:").grid(row=2, column=0, padx=5, pady=0)
    tk.Label(frame_aba1, text="Dobra 4:").grid(row=3, column=0, padx=5, pady=0)
    tk.Label(frame_aba1, text="Dobra 5:").grid(row=4, column=0, padx=5, pady=0)

    # Entradas para inserir valores de dobra
    g.dobra1 = tk.Entry(frame_aba1)
    g.dobra1.grid(row=0, column=1, padx=5, pady=0)
    g.dobra2 = tk.Entry(frame_aba1)
    g.dobra2.grid(row=1, column=1, padx=5, pady=0)
    g.dobra3 = tk.Entry(frame_aba1)
    g.dobra3.grid(row=2, column=1, padx=5, pady=0)
    g.dobra4 = tk.Entry(frame_aba1)
    g.dobra4.grid(row=3, column=1, padx=5, pady=0)
    g.dobra5 = tk.Entry(frame_aba1)
    g.dobra5.grid(row=4, column=1, padx=5, pady=0)

    # Medida da linha de dobra
    g.medidadobra1_entry = tk.Entry(frame_aba1, state='readonly')
    g.medidadobra1_entry.grid(row=0, column=2, padx=5, pady=0)
    g.medidadobra2_entry = tk.Entry(frame_aba1, state='readonly')
    g.medidadobra2_entry.grid(row=1, column=2, padx=5, pady=0)
    g.medidadobra3_entry = tk.Entry(frame_aba1, state='readonly')
    g.medidadobra3_entry.grid(row=2, column=2, padx=5, pady=0)
    g.medidadobra4_entry = tk.Entry(frame_aba1, state='readonly')
    g.medidadobra4_entry.grid(row=3, column=2, padx=5, pady=0)
    g.medidadobra5_entry = tk.Entry(frame_aba1, state='readonly')
    g.medidadobra5_entry.grid(row=4, column=2, padx=5, pady=0)

    # Medida da linha de dobra
    g.metadedobra1_entry = tk.Entry(frame_aba1, state='readonly')
    g.metadedobra1_entry.grid(row=0, column=3, padx=5, pady=0)
    g.metadedobra2_entry = tk.Entry(frame_aba1, state='readonly')
    g.metadedobra2_entry.grid(row=1, column=3, padx=5, pady=0)
    g.metadedobra3_entry = tk.Entry(frame_aba1, state='readonly')
    g.metadedobra3_entry.grid(row=2, column=3, padx=5, pady=0)
    g.metadedobra4_entry = tk.Entry(frame_aba1, state='readonly')
    g.metadedobra4_entry.grid(row=3, column=3, padx=5, pady=0)
    g.metadedobra5_entry = tk.Entry(frame_aba1, state='readonly')
    g.metadedobra5_entry.grid(row=4, column=3, padx=5, pady=0)
